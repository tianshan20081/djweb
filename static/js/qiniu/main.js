...
$(function() {
  var uploader = Qiniu.uploader({
    ...
    flash_swf_url: 'http://p0mk9doif.bkt.clouddn.com/Moxie.swf',
    dragdrop: true,
    chunk_size: '4mb',
    domain:'http://p0mk9doif.bkt.clouddn.com/',
    // multi_selection: !(moxie.core.utils.Env.OS.toLowerCase() === "ios"),
    uptoken_url:'http://47.104.103.72:8000/api/file/up_token_web',
    // uptoken_url: $('#uptoken_url').val(),
    // uptoken_func: function(){
    //     var ajax = new XMLHttpRequest();
    //     var url = $('#uptoken_url').val() + 'bucket=pupload&key=test'
    ...
    // domain:'http://7xisea.com1.z0.glb.clouddn.com/',
    // domain:'http://dn-gooker.qbox.me',
